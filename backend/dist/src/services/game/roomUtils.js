...
exports.startGameCountdown = startGameCountdown;
exports.startGame = startGame;
exports.checkAndStartGame = checkAndStartGame;
exports.findAvailableRoom = findAvailableRoom;
const GameEngine_1 = require("../../services/game/GameEngine");
...
(function (MessageType) {
    ...
    MessageType["GAME_START"] = "gameStart";
    MessageType["GAME_STATE"] = "gameState";
    MessageType["GAME_OVER"] = "gameOver";
    // プレイヤー操作関連
    MessageType["PADDLE_MOVE"] = "paddleMove";
    MessageType["PADDLE_STATE"] = "paddleState";
    MessageType["SURRENDER"] = "surrender";
    // 設定関連
    MessageType["GAME_SETTINGS"] = "gameSettings";
    // コミュニケーション関連
...
function startGame(room) {
    ...
    // ゲームループを開始
    const gameEngine = new GameEngine_1.GameEngine(room.gameState);
 ...
 */
function findAvailableRoom(gameRooms) {
    // 既存の空きルームを探す
